...
declare module 'mongoose' {
  ...
  interface ModelPopulateOptions extends QueryPopulateOptions {
    /** optional, if true Mongoose will always set
     * path to an array. Inferred from schema by default */
    justOne?: boolean;
  }
  ...
  interface PaginateOptions {
    ...
    limit?: number;
    read?: ReadOptions;
    /* If pagination is set to `false`, it will return
    all docs without adding limit condition. (Default: `true`) */
    pagination?: boolean;
    projection?: any;
